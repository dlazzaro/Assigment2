...
public class SandwichShopManagerTest extends Assert {
    ...
    public void OrderCannotExceed30Elements() throws TakeAwayBillException{
        ...
        prova.getOrderPrice(listaProva);
    }
    
    @Test
    public void CommissionOf50CentsIfOrderIsLessThan10Euros() throws TakeAwayBillException{
        listaProva.add(doppiaCarne);
        assertEquals(prova.getOrderPrice(listaProva),7.5, 0.0);
    }
}
